...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('%c🎵 Welcome to Peterphonist Website! 🎵', 'font-size: 20px; font-weight: bold; color: #0d6efd;');
    console.log('%cProfessional Saxophonist Services', 'font-size: 14px; color: #6c757d;');
    console.log('%cBuilt with ❤️ by Peter Lightspeed', 'font-size: 12px; color: #198754;');
});
